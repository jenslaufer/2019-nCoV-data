...
```{r fig.height=10, fig.width=20}
feature <- "parks_percent_change_from_baseline"
mobility.data.model.data <- (
  mobility.data %>%
    group_by(country_region, sub_region_1) %>%
    fit.loess.model(feature, "timestamp")
...
mobility.data.model.data %>%
  ...
  plot.model.data(.feature1 = "date", .feature2 = feature, .show.noise = F)
```
...
mobility.data.model.data %>% 
  ...
  plot.model.data(.feature1 = "date", .feature2 = feature, .show.noise = T)
```
