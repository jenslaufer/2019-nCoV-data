...
```{r}
feature <- "overall_percent_change_from_baseline_diff"
mobility.data.model.data <-
  (
...
mobility.data.model.data %>%
  ...
  select(country_region, sub_region_1, overall_percent_change_from_baseline, overall_percent_change_from_baseline_diff) %>% 
  mutate(lag=overall_percent_change_from_baseline/lag(abs(overall_percent_change_from_baseline))) 
```
