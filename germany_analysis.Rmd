...
filtered <- filtered %>%
  bind_rows(filtered %>% add.forecast("Germany")) %>%
  bind_rows(filtered %>% add.forecast("South Korea")) %>%
  bind_rows(filtered %>% add.forecast("France")) %>%
  bind_rows(filtered %>% add.forecast("Italy")) %>% 
  bind_rows(filtered %>% add.forecast("United States")) %>%
  bind_rows(filtered %>% add.forecast("Iran")) %>% 
  bind_rows(filtered %>% add.forecast("United Kingdom")) %>%
  bind_rows(filtered %>% add.forecast("Spain")) %>%
  bind_rows(filtered %>% add.forecast("Japan")) %>%
  bind_rows(filtered %>% add.forecast("Netherlands"))%>%
  bind_rows(filtered %>% add.forecast("Sweden"))%>%
  bind_rows(filtered %>% add.forecast("Switzerland"))%>%
  group_by(name) %>%
